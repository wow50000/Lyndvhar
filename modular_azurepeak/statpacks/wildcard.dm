...
/datum/statpack/wildcard/wretched
	name = "Wretched"
	desc = "The cruelty of Lyndvhar leaves many in its wake - you among them. But with her terrible eye turned elsewhere, perhaps it is time for your fortune to be made..."
	stat_array = list(STAT_STRENGTH = -2, STAT_PERCEPTION = -2, STAT_INTELLIGENCE = -2, STAT_CONSTITUTION = -2, STAT_ENDURANCE = -2, STAT_FORTUNE = 4)

/datum/statpack/wildcard/fated
	name = "Fated"
	desc = "The first or the last - let destiny's fickle loom decree what your fate shall be."
	stat_array = list(STAT_STRENGTH = list(-1, 2), STAT_PERCEPTION = list(-1, 2), STAT_INTELLIGENCE = list(-1, 2), STAT_CONSTITUTION = list(-1, 2), STAT_ENDURANCE = list(-1, 2), STAT_SPEED = list(-1, 2), STAT_FORTUNE = 2)
...
/*/datum/statpack/wildcard/austere
	...
	Pointless with Virtuous around.*/
