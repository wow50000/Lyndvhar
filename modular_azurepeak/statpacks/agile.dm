...
/datum/statpack/agile/tricky
	...
	stat_array = list(STAT_STRENGTH = -1, STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 1, STAT_ENDURANCE = -1, STAT_SPEED = 2, STAT_FORTUNE = list(-1, 2))
...
/datum/statpack/agile/thug
	...
	stat_array = list(STAT_STRENGTH = 2, STAT_PERCEPTION = 2, STAT_INTELLIGENCE = -1, STAT_SPEED = -1)
