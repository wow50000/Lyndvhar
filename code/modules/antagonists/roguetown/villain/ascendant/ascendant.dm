/datum/antagonist/ascendant
	...
	antag_memory = "<b>THERE ARE NO TRUE GODS. The Pantheon ARE WEAK, and the Archdaemons ARE FOOLISH. The WORLD IS DYING, AND I AM THE ONLY THING THAT MAY SAVE IT- MAY MY BLADE BLOODY ME UNTIL IT IS DONE.</b>"
