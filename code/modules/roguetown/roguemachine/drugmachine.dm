...
/obj/structure/roguemachine/drugmachine/Initialize()
	...
	update_icon()
	held_items[/obj/item/reagent_containers/powder/spice] = list("PRICE" = rand(25,30),"NAME" = "chuckledust")
	held_items[/obj/item/reagent_containers/powder/ozium] = list("PRICE" = rand(5,8),"NAME" = "ozium")
	held_items[/obj/item/reagent_containers/powder/ozium] = list("PRICE" = rand(18,24),"NAME" = "purified ozium")
	held_items[/obj/item/reagent_containers/powder/moondust] = list("PRICE" = rand(13,25),"NAME" = "moondust")
	held_items[/obj/item/reagent_containers/powder/starsugar] = list("PRICE" = rand(120,145),"NAME" = "starsugar")
