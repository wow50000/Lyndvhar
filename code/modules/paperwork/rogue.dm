...
/obj/item/paper/confession
	...
	info = "THE GUILTY PARTY ADMITS THEIR SIN AND THE WEAKENING OF OUR HOLY FLOCK. THEY WILL REPENT AND SUBMIT TO ANY PUNISHMENT THE CLERGY DEEMS APPROPRIATE, OR BE RELEASED IMMEDIATELY. LET THIS RECORD OF THEIR SIN WEIGH ON THE JUDGEMENT AT THE GATES OF ETERNITY.<br/><br/>SIGNED,"
	var/signed = FALSE
	textper = 150
...
/obj/item/paper/confession/attack(mob/living/carbon/human/M, mob/user)
	...
	if(!M.stat)
		...
		M.add_stress(/datum/stressevent/confessed)
		signed = M.real_name
		info = "THE GUILTY PARTY ADMITS THEIR SIN AND THE WEAKENING OF OUR HOLY FLOCK. THEY WILL REPENT AND SUBMIT TO ANY PUNISHMENT THE CLERGY DEEMS APPROPRIATE, OR BE RELEASED IMMEDIATELY. LET THIS RECORD OF THEIR SIN WEIGH ON THE JUDGEMENT AT THE GATES OF ETERNITY.<br/><br/>SIGNED,<br/><font color='red'>[signed]</font>"
