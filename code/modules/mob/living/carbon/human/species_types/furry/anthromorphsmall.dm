...
/datum/species/anthromorphsmall
	name = "Verminvolk"
	id = "anthromorphsmall"
	desc = "Crafted in much the same way as the Wild-Kin, the Verminvolk, or Small-Wildlings, these beings face even more resentment and hatred compared to their Wild-Kin siblings, as they were formed from pest animals, such as rodents.<br>"
	default_color = "444"
	species_traits = list(
		MUTCOLORS,
		EYECOLOR,
