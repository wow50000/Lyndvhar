/datum/advclass/wretch
	...
	classes = list("Deserter" = "You were once a venerated and revered knight - now, a traitor who abandoned your liege. You live the life of an outlaw, shunned and looked down upon by society.",
					...
					"Heretic" = "You are a heretic, wanted dead by the church, cast out from most societies - and hated by Astrata and her siblings for your occult belief.",
...
/datum/outfit/job/roguetown/adventurer/wretch/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Heretic")
			to_chat(H, span_warning("You are a heretic, wanted dead by the church, cast out from most societies - and hated by Astrata and her siblings for your occult belief."))
