...
/datum/outfit/job/roguetown/guardsman
	...
	belt = /obj/item/storage/belt/rogue/leather	//Would seperate to leather bracers for archer for dodge but - funnily, armor class doesn't exist on bracers.
...
/datum/outfit/job/roguetown/guardsman/pikeman/pre_equip(mob/living/carbon/human/H)
	...
	armor = pickweight(list(/obj/item/clothing/suit/roguetown/armor/leather/heavy = 4, /obj/item/clothing/suit/roguetown/armor/chainmail/iron = 3, /obj/item/clothing/suit/roguetown/armor/plate/half = 2))
	backr = /obj/item/storage/backpack/rogue/satchel
	beltl = /obj/item/storage/keyring/guardcastle
