...
"MAJENTA"="#962e5c")// AN ALBANIAN
	var/prim
	var/sec
	var/choice = input(src, "Choose a Primary Color", "LYNDVHAR") as anything in lordcolors
	if(choice)
		prim = lordcolors[choice]
		lordcolors -= choice
	choice = input(src, "Choose a Secondary Color", "LYNDVHAR") as anything in lordcolors
	if(choice)
