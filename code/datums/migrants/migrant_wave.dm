...
/datum/migrant_wave/pilgrim
	...
	greet_text = "Fleeing from misfortune and hardship, you and a handful of survivors get closer to Lyndvhar, looking for refuge and work, finally almost being there, almost..."
